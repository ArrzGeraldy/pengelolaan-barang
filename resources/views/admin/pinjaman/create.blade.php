    ...
    <div class="w-full h-screen flex relative">
      ...
      >
        ...
        <div class="flex-1 overflow-y-auto p-6 bg-slate-50">
          ...
          >
            <div>
              ...
              <p class="text-sm mt-1">
                Tambah pinjaman inventaris dengan pilihan jurusan dan kategori.
              </p>
            </div>
          </div>
          <x-alert-message />
          ...
          >
            <form action="{{ route('admin.pinjaman.store') }}" method="POST" class="grid md:grid-cols-2 gap-x-6 gap-y-2">
              @csrf

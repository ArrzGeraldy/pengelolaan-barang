      ...
      >
        ...
        <div class="flex-1 overflow-y-auto p-6 bg-slate-50">
          ...
          >
            <div>
              ...
              <p class="text-sm mt-1">
                Kelola daftar kategori dan hak akses inventaris barang SMK.
              </p>
            </div>
            <div>
              <a
          ...
          <div class="mb-5 flex flex-wrap items-center justify-between gap-4">
            <form action="{{ route('admin.kategori.index') }}" method="GET" class="flex items-center gap-2 w-full sm:w-auto">
                    ...
                    <td colspan="4" class="px-6 py-12 text-center">
                      <div class="flex flex-col items-center justify-center">
                        ...
                        <p class="text-xs text-slate-400 mt-0.5">
                          Silakan tambah data kategori baru terlebih dahulu.
                        </p>
                      </div>
                    </td>
                  </tr>
          ...
          <x-simple-pagination :data="$kategoris"/>
        </div>
      </main>
    </div>
  </body>

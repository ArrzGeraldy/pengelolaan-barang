      ...
      >
        ...
        <div class="flex-1 overflow-y-auto p-6 bg-slate-50">
          ...
          >
            <div>
              ...
              <p class="text-sm mt-1">
                Kelola daftar barang inventaris dan pilih jurusan serta kategori.
              </p>
            </div>
            <div>
              <a
          ...
          <div class="mb-6 bg-white p-4 rounded-xl border border-slate-100 shadow-sm">
            <form action="{{ route('admin.barang.index') }}" method="GET" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 items-end">
              
              <div>
                <label class="block text-xs font-semibold text-slate-500 mb-1.5">Cari Barang</label>
                <div class="relative">
              ...
              <div >
                <label class="block text-xs font-semibold text-slate-500 mb-1.5">Jurusan</label>
                <select 
                  name="jurusan_id" 
                  class="block w-full py-2 px-3 text-sm border border-orange-200 rounded-xl focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 bg-transparent text-slate-700"
                >
              ...
              <div class="flex gap-2">
                ...
                @if(request()->anyFilled(['search', 'kategori_id', 'jurusan_id']))
                  <a 
              ...
              <table class="w-full text-left border-collapse">
                <thead>
                  <tr class="bg-orange-100 border-b border-slate-200">
                    <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-700 w-16 text-center">
                      No
                    </th>
                    <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-700">
                      Kode
                    </th>
                    <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-700">
                      Nama
                    ...
                    <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-700 text-center">
                      Stok
                    </th>
                    <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-700 text-right w-40">
                      Aksi
                    </th>
                  </tr>
                </thead>
                <tbody class="divide-y divide-slate-100">
                  ...
                  <tr class="hover:bg-slate-50/70 transition-colors">
                    ...
                    <td class="px-6 py-4 text-sm">
                        ...
                        <span class="inline-flex items-center px-2.5 py-1 rounded-md text-sm font-semibold bg-orange-50 text-orange-700 border border-orange-100" > 
                            {{ $barang->nama }}
                        </span>
                    </td>
                    <td class="px-6 py-4 text-sm">
                    ...
                    <td class="px-6 py-4 text-sm text-center">
                      {{ $barang->stock_tersedia }} / {{ $barang->stok_total }}
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td colspan="7" class="px-6 py-12 text-center">
                      <div class="flex flex-col items-center justify-center">
                        ...
                        <p class="text-xs text-slate-400 mt-0.5">
                          Silakan tambah barang inventaris baru terlebih dahulu.
                        </p>
                      </div>
                    </td>
                  </tr>
          ...
          <x-simple-pagination :data="$barangs"/>
